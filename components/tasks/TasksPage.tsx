        ...
        <div className="content-panel">
          <section className="content">
            <div className="dashboard-summary">
              <div
                className={[
                  ...
                  filters.includes("completed")
                    ? "dashboard-card--active dashboard-card--success"
                    : "",
                ]
                  .filter(Boolean)
                  .join(" ")}
              ...
              >
                <span className="material-icons dashboard-card__icon">
                  check_circle
                </span>
              ...
              <div
                className={[
                  ...
                  "dashboard-card--star",
                  "dashboard-card--clickable",
                  filters.includes("starred")
                    ? "dashboard-card--active dashboard-card--star"
                    : "",
                ]
                  .filter(Boolean)
                  .join(" ")}
              ...
              <div
                className={[
                  ...
                  filters.includes("overdue")
                    ? "dashboard-card--active dashboard-card--danger"
                    : "",
                ]
                  .filter(Boolean)
                  .join(" ")}
              ...
              <div
                className={[
                  ...
                  "dashboard-card--info",
                  "dashboard-card--clickable",
                  filters.includes("upcoming")
                    ? "dashboard-card--active dashboard-card--info"
                    : "",
                ]
                  .filter(Boolean)
                  .join(" ")}
            ...
            {!canManage ? (
              <div className={`${styles.message} ${styles.messageReadOnly}`}>
                Read-only mode: sign in is required to manage tasks.
              </div>
            ) : null}
            {loading ? (
            ...
            <div
              className={`filter-flat-view tasks-filter-view ${styles.filterView}`}
            >
              {filtered.length === 0 ? (
            ...
            {filters.length === 0 && (
              <div className={`add-bar-wrapper ${styles.addBarWrapper}`}>
                <AddBar
                    id="tasks-page-add-input"
                    type="tasks"
                  input={input}
                  dueDate={dueDate}
              ...
              <button
                ...
                onClick={() => {
                  requestAnimationFrame(() => {
                    const el = document.getElementById("tasks-page-add-input") as HTMLInputElement | null;
                    if (el) el.focus();
                  });
                }}
              >
